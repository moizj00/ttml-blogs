---
title: "Small Claims Court vs. Demand Letter: Which Is Faster for Unpaid Invoices in California?"
slug: small-claims-court-vs-demand-letter-california
description: "Comparing small claims court and attorney demand letters for unpaid invoices in California — which is faster, cheaper, and more likely to get you paid?"
excerpt: "California small claims court and attorney demand letters are both real options for collecting unpaid invoices — but they work differently, cost different amounts, and suit different situations. Here's how to choose the right one."
date: 2026-05-14
author: "Talk to My Lawyer Team"
category: demand-letters
tags: ["small claims court", "demand letter", "unpaid invoices", "california", "comparison"]
status: published
---
...
| Factor | Attorney Demand Letter | Small Claims Court |
|---|---|---|
| Time to resolution | Days to weeks (if successful) | 3 to 6+ months |
| Out-of-pocket cost | Low flat fee | Filing fee plus your time plus possible enforcement costs |
| Requires court appearance | No | Yes |
| Creates formal legal record | Yes | Yes (stronger: court judgment) |
| Enforces itself | No — client must choose to pay | No — judgment still requires collection steps |
| Best for | Most unpaid invoice situations | After demand fails; amounts near the limit |

## Which Should You Choose?

**Start with the demand letter if:**
- The client is unresponsive but hasn't explicitly refused to pay
- You want resolution in days or weeks rather than months
- The invoice is well-documented and your agreement is clear
- You'd rather avoid taking time away from work to attend a court hearing

**Go straight to small claims if:**
- You've already sent a formal demand and the client ignored it
- The client has explicitly refused to pay and communication has broken down entirely
- The amount is at or near the $12,500 limit and your evidence is strong
- You specifically want a court judgment — for example, to place a judgment lien
